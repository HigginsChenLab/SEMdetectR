#' Illumina Probe Annotations Dataframe for the EPIC array
#'
...
#' @name probe_annotationsEPIC.rda
#' @format A data frame with 866836 rows and 9 columns:
#' \describe{
...
#' }
#' @source Taken from the Illumina manifest for the EPICk array
"probe_annotations"
